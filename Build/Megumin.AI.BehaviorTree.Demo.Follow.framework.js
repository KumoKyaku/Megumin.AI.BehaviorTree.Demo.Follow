...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_getMetricsInfo")) {
 Object.defineProperty(Module["ready"], "_getMetricsInfo", {
  configurable: true,
  get: function() {
   abort("You are getting _getMetricsInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_getMetricsInfo", {
  configurable: true,
  set: function() {
   abort("You are setting _getMetricsInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
function _GetJSLoadTimeInfo(loadTimePtr) {
 ...
 HEAPU32[(loadTimePtr >> 2) + 1 >>> 0] = Module.dataUrlLoadEndTime || 0;
 HEAPU32[(loadTimePtr >> 2) + 2 >>> 0] = Module.codeDownloadTimeEnd || 0;
}
...
function JS_Accelerometer_eventHandler() {
 ...
 if (JS_Accelerometer_callback != 0) (function(a1, a2, a3) {
...
function JS_DeviceMotion_eventHandler(event) {
 ...
 if (JS_LinearAccelerationSensor_callback != 0) (function(a1, a2, a3) {
...
function JS_GravitySensor_eventHandler() {
 if (JS_GravitySensor_callback != 0) (function(a1, a2, a3) {
  dynCall_vfff.apply(null, [ JS_GravitySensor_callback, a1, a2, a3 ]);
...
function JS_Gyroscope_eventHandler() {
 if (JS_Gyroscope_callback != 0) (function(a1, a2, a3) {
  dynCall_vfff.apply(null, [ JS_Gyroscope_callback, a1, a2, a3 ]);
...
function JS_OrientationSensor_eventHandler() {
 if (JS_OrientationSensor_callback != 0) (function(a1, a2, a3, a4) {
